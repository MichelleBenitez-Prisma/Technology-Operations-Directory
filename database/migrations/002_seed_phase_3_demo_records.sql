...
VALUES
    ...
    ((SELECT id FROM technology_assets WHERE asset_key = 'TECH-DEPT-WEBSITE'), 'Technology', 'Technology Operations', 'Technology Operations', 'Internal', 'Technology Support', 'Legacy IIS', 'WEB-LEGACY-01', NULL, NULL, NULL, NULL, 'Corporate Intranet Technology Hub', 'Retired after acquisition. Keep record for old inventory and redirect history.', 'Retired sample record.');((SELECT id FROM technology_assests WHERE asset_key = 'DOKSHOP'), 'Print Operations', 'John Doe', 'Jane Smith', 'Legacy Systems Inc.', '